...
class YOLO(object):
    ...
    def detect_bounding_boxes(self, image):
        ...
        image_data = boxed_image.astype(dtype=np.float32)/255.0
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            annotated_img = cv2.rectangle(annotated_img, (left, top), (right, bottom), (255, 0, 0), thickness)
            annotated_img = cv2.putText(annotated_img, label, text_origin, cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0))
